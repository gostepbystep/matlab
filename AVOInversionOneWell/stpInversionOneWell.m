...
welllog = stp1CalcWellLog(sWell.fileName, sWell.depth, 200, dt);
...
%% 第五步，超道集转换为角道集
[angleSeisData, angleData] = stp5Anglegather(superTrData, outWelllog, angleTrNum, offsetMin, offsetMax, dt);
